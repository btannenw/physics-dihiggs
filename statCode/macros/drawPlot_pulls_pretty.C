...
TString translateNPname(TString internalName, bool isMVA){
    if(internalName == "ATLAS_norm_Wbb") return "W+b#bar{b} normalisation";
if(internalName == "ATLAS_norm_Wcl") return "W+cl normalisation";
if(internalName == "ATLAS_norm_Zbb") return "Z+b#bar{b} normalisation";
if(internalName == "ATLAS_norm_Zcl") return "Z+cl normalisation";
if(internalName == "ATLAS_norm_ttbar_L0") return "Zerolepton t#bar{t} normalisation";
if(internalName == "ATLAS_norm_ttbar_L1") return "Singlelepton t#bar{t} normalisation";
if(internalName == "ATLAS_norm_ttbar_L2") return "Dilepton t#bar{t} normalisation";
if(internalName == "alpha_ATLAS_LUMI_2012") return "Luminosity";
if(internalName == "alpha_SysBJetReso") return "b-jet energy resolution";
if(internalName == "alpha_SysBTagB0Effic_Y2012") return "truth b-jet b-tagging efficiency 0";
if(internalName == "alpha_SysBTagB1Effic_Y2012") return "truth b-jet b-tagging efficiency 1";
if(internalName == "alpha_SysBTagB2Effic_Y2012") return "truth b-jet b-tagging efficiency 2";
if(internalName == "alpha_SysBTagB3Effic_Y2012") return "truth b-jet b-tagging efficiency 3";
if(internalName == "alpha_SysBTagB4Effic_Y2012") return "truth b-jet b-tagging efficiency 4";
if(internalName == "alpha_SysBTagB5Effic_Y2012") return "truth b-jet b-tagging efficiency 5";
if(internalName == "alpha_SysBTagB6Effic_Y2012") return "truth b-jet b-tagging efficiency 6";
if(internalName == "alpha_SysBTagB7Effic_Y2012") return "truth b-jet b-tagging efficiency 7";
if(internalName == "alpha_SysBTagB8Effic_Y2012") return "truth b-jet b-tagging efficiency 8";
if(internalName == "alpha_SysBTagB9Effic_Y2012") return "truth b-jet b-tagging efficiency 9";
if(internalName == "alpha_SysBTagBPythia8_Y2012") return "Generator dependence of b-tagging eff.";
if(internalName == "alpha_SysBTagBSherpa_Y2012") return "Generator dependence of b-tagging eff.(for Sherpa)";
if(internalName == "alpha_SysBTagC0Effic_Y2012") return "truth c-jet b-tagging efficiency 0";
if(internalName == "alpha_SysBTagC1Effic_Y2012") return "truth c-jet b-tagging efficiency 1";
if(internalName == "alpha_SysBTagC2Effic_Y2012") return "truth c-jet b-tagging efficiency 2";
if(internalName == "alpha_SysBTagC3Effic_Y2012") return "truth c-jet b-tagging efficiency 3";
if(internalName == "alpha_SysBTagC4Effic_Y2012") return "truth c-jet b-tagging efficiency 4";
if(internalName == "alpha_SysBTagC5Effic_Y2012") return "truth c-jet b-tagging efficiency 5";
if(internalName == "alpha_SysBTagC6Effic_Y2012") return "truth c-jet b-tagging efficiency 6";
if(internalName == "alpha_SysBTagC7Effic_Y2012") return "truth c-jet b-tagging efficiency 7";
if(internalName == "alpha_SysBTagC8Effic_Y2012") return "truth c-jet b-tagging efficiency 8";
if(internalName == "alpha_SysBTagC9Effic_Y2012") return "truth c-jet b-tagging efficiency 9";
if(internalName == "alpha_SysBTagC10Effic_Y2012") return "truth c-jet b-tagging efficiency 10";
if(internalName == "alpha_SysBTagC11Effic_Y2012") return "truth c-jet b-tagging efficiency 11";
if(internalName == "alpha_SysBTagC12Effic_Y2012") return "truth c-jet b-tagging efficiency 12";
if(internalName == "alpha_SysBTagC13Effic_Y2012") return "truth c-jet b-tagging efficiency 13";
if(internalName == "alpha_SysBTagC14Effic_Y2012") return "truth c-jet b-tagging efficiency 14";
if(internalName == "alpha_SysBTagCPythia8_Y2012") return "Generator dependence of b-tagging eff. (for charm)";
if(internalName == "alpha_SysBTagCSherpa_Y2012") return "Generator dependence of b-tagging eff. (for Sherpa, charm)";
if(internalName == "alpha_SysBTagL0Effic_Y2012") return "truth l-jet b-tagging efficiency 0";
if(internalName == "alpha_SysBTagL1Effic_Y2012") return "truth l-jet b-tagging efficiency 1";
if(internalName == "alpha_SysBTagL2Effic_Y2012") return "truth l-jet b-tagging efficiency 2";
if(internalName == "alpha_SysBTagL3Effic_Y2012") return "truth l-jet b-tagging efficiency 3";
if(internalName == "alpha_SysBTagL4Effic_Y2012") return "truth l-jet b-tagging efficiency 4";
if(internalName == "alpha_SysBTagL5Effic_Y2012") return "truth l-jet b-tagging efficiency 5";
if(internalName == "alpha_SysBTagL6Effic_Y2012") return "truth l-jet b-tagging efficiency 6";
if(internalName == "alpha_SysBTagL7Effic_Y2012") return "truth l-jet b-tagging efficiency 7";
if(internalName == "alpha_SysBTagL8Effic_Y2012") return "truth l-jet b-tagging efficiency 8";
if(internalName == "alpha_SysBTagL9Effic_Y2012") return "truth l-jet b-tagging efficiency 9";
...
if(internalName == "alpha_SysMJ_L2_Y2012") return "Dilepton multijet";
//if(internalName == "alpha_SysMuonEffic")
//if(internalName == "alpha_SysSChanAcerMC")
//if(internalName == "alpha_SysSChanAcerMCPS")
if(internalName == "alpha_SysTChanPtB2") return "Single top t-channel 2nd jet p_{T}";
...
if(internalName == "alpha_SysTheoryVPtQCD") return "signal shape uncertainty from QCD/PDF";
if(internalName == "alpha_SysTheoryVPtQCD_ggZH") return "ggZH shape uncertainty from QCD/PDF";
if(internalName == "alpha_SysTheoryVPtQCD_qqVH") return "qqVH shape uncertainty from QCD/PDF";
if(internalName == "alpha_SysTopPt") return "ttbar truth avg p_{T} modeling";
if(internalName == "alpha_SysTruthTagDR_Y2012") return "truth tagging DR modeling";
if(internalName == "alpha_SysTtbarMBBCont") return "ttbar m_{jj} shape";
...
if(internalName == "alpha_SysWMbb_B1_WbbORcc") return "W+b#bar{b}, W+c#bar{c} m_{jj} shape (90 < p_{T}^{V} < 120 GeV)";
if(internalName == "alpha_SysWMbb_WbbORcc") return "W+b#bar{b}, W+c#bar{c} m_{jj} shape (p_{T}^{V} > 120 GeV)";
...
if(internalName == "alpha_SysWblWbbRatio") return "W+bl to W+b#bar{b} normalisation (p_{T}^{V} > 120 GeV)";
...
if(internalName == "alpha_SysWblWbbRatio_B1") return "W+bl to W+b#bar{b} normalisation (90 GeV < p_{T}^{V} < 120 GeV)";
...
if(internalName == "alpha_SysZbbNorm_J3") return "Z+b#bar{b} normalisation (3-jet)";
...
if(internalName == "alpha_SysZclNorm") return "Z+cl normalization";
...
if(internalName == "alpha_SysttbarHighPtV") return "ttbar high p_{T}^{V}";
if(internalName == "alpha_SysttbarNorm_J3") return "ttbar normalization (3-jet)";
if(internalName == "alpha_SysttbarNorm_J3_L2") return "ttbar normalization (3-jet, dilepton)";
if(internalName == "alpha_SysMJ_L2_Y2012_Spctopemucr") return "Dilepton Multijet (top C.R.)";
    return internalName;
}
