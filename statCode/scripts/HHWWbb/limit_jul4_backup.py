...
if __name__ == '__main__':
    ...
    #plot("1182X.280616-v1-negQCD_asimovFit_HH_13TeV_280616-v1-negQCD_asimovFit_FloatOnly_{0}_exp", masses, same=False, legend = "exp (H, SLT, 3.2 fb-1), optNoLH") # No negative QCD fix
    ...
    #plot("1182X.010616-noLH-allBkgs_HH_13TeV_010616-noLH-allBkgs_StatOnly_{0}_exp", masses, same=False, legend = "exp (H, SLT, 3.2 fb-1), optNoLH")
