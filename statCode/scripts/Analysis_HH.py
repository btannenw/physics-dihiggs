...
InputVersion = "HH131115"

def add_config(mass, unc = "Systs", mcstats=True, one_bin=False):
...
if __name__ == "__main__":
    ...
    for m in masses:
        configfiles_stat += add_config(str(m), "FloatOnly") #"StatOnly")
...
#     tasks += ["-t", "0,2"]     # yield tables (CPU intense)
    ...
    Batch.run_lxplus_batch(configfiles_stat, outversion, tasks)
    sys.exit()
