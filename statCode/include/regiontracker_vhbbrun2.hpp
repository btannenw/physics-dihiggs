#ifndef regiontracker_vhbbrun2_hpp
#define regiontracker_vhbbrun2_hpp
...
/**
 * @brief Implementation of the @c RegionTracker for the Run1 VHbb analysis
 *
 */
class RegionTracker_VHbbRun2 : public RegionTracker
{

  public:
    /// Default constructor
    RegionTracker_VHbbRun2() = default;

    /// Default destructor
    virtual ~RegionTracker_VHbbRun2() = default;
     ...
     *
     * Sets 0+1+2 lepton, 2+3 jets, 2 tags.
     *
     */
