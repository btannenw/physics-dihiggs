#ifndef systematiclistsbuilder_hh_hpp
#define systematiclistsbuilder_hh_hpp
 ...
 *
 */
class SystematicListsBuilder_HH : public SystematicListsBuilder
{
  public:
    ...
    /// Empty destructor
    virtual ~SystematicListsBuilder_HH() {}
